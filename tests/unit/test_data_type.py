...
class TheTimestampClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::TIMESTAMP')
...
class TheIntervalClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::INTERVAL')
...
class TheDateClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::DATE')
...
class TheNumericClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::NUMERIC')

    def test_works_with_args(self):
        param = NUMERIC('param', 10, 2)

        self.assertEqual(unicode(param), '(param)::NUMERIC(10, 2)')
...
class TheDecimalClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::DECIMAL')

    def test_works_with_args(self):
        param = DECIMAL('param', 10, 2)

        self.assertEqual(unicode(param), '(param)::DECIMAL(10, 2)')
...
class TheIntegerClassToStringMethod(unittest.TestCase):
    def test_works(self):
        ...
        self.assertEqual(unicode(param), '(param)::INTEGER')
